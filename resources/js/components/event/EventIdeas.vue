            ...
            <div v-else class="ideas border border-gray-200 bg-gray-100 p-3 my-3 overflow-y-scroll h-64">
                <div v-for="i in eventPresentIdeas" class="border-b border-gray-300 pb-4 my-2">
                    ...
                    <div class="flex items-start">
                        ...
                        <button class="w-1/6 bg-blue-600 p-2 text-white text-sm rounded" @click="vote()">
                            <font-awesome-icon :icon="['fas', 'heart']" class="text-white text-base mr-2" /> ({{ i.voted }} votes)
                        </button>
                    </div>
                </div>
            </div>
